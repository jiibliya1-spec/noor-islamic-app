...
export default function SurahDetail() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl mx-auto min-h-screen relative pb-32">
      ...
      {surahNumber !== 1 && surahNumber !== 9 && (
        <div className="text-center py-8 mb-8">
          <h3 className="text-4xl font-quran text-foreground leading-loose">بِسْمِ ٱللَّهِ ٱلرَّحْمَٰنِ ٱلرَّحِيمِ</h3>
        </div>
      )}
